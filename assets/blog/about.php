		...
		<div class="container">
			<div class="w3_agile_banner_top">
				<div class="agile_phone_mail">
					<ul>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+(254) 754 235 535</li>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:mightyeagsocceracademy@gmail.com">mightyeagsocceracademy@gmail</a></li>
					</ul>
				</div>
			</div>
				...
				<div class="container">
					...
					<div class="statistics-grids">
						<div class="col-md-3 statistics-grid">
							<div class="counter numscroller"> 7</div>
